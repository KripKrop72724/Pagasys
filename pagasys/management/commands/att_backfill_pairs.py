...
from pagasys.tasks_attendance import pair_events_task


class Command(BaseCommand):
    help = "Backfill attendance pairs for a company over a date range"
    ...
    def handle(self, *args, **opts):
        ...
        while cur <= date_to:
            for emp in employees:
                pair_events_task.delay(company_id, emp.id, cur.isoformat())
