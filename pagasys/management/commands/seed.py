...
class Command(BaseCommand):
    ...
    def _create_demo_data(self):
        ...
        # Companies
        acme, _ = Company.objects.get_or_create(name="Acme Corp")
        beta, _ = Company.objects.get_or_create(name="Beta LLC")
        ...
        # Trade licenses covering all branches for each company
        ...
        # Employees including super user
