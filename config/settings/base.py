...
ALLOWED_HOSTS = env.list(
    "ALLOWED_HOSTS", default=["localhost", ".elasticbeanstalk.com", "127.0.0.1", "0.0.0.0", "api.pagasys.pro", "pagasysv1.vercel.app", "prodapi.pagasys.pro", "ats.pagasys.pro", "40.172.70.127"]
)
